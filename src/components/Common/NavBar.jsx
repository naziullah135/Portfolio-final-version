        ...
        <Box sx={{ textAlign: 'center' }}>
            ...
            <List>
                {navItems.map(({ label, path }) => (
                    ...
                    //         <ElementMobile />
                    //     </NestedMenu> :
                        <Link style={{textDecoration:"none"}} key={label} href={path} >
            ...
            <Nav>
                <Container>
                    <Toolbar sx={{ padding: "0 !important" }}>
                        ...
                        >
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="#3D00B7" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Box sx={{ display: { md: 'block', xs: 'none' },'& button': { ml: 2 } }}>
                           ...
                           {navItems.map(({ label, path }) => (
                                ...
                                //     </MegaMenu>
                                //     :
                                    <Link style={{textDecoration:"none"}} key={label} href={path} passHref>
                                        <Box sx={navItemStyle}>
                                            {label}
                                        </Box>
                                    </Link>
